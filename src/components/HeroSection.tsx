      ...
      <div className="relative z-10 section-container text-center text-primary-foreground">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="animate-fade-up">
            <span className="inline-block px-4 py-2 rounded-full bg-accent/20 text-gold-light text-sm font-medium tracking-wide">
              Welcome to the Family of God
            </span>
          </div>

          {/* Main Title */}
          <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-up delay-100">
            Now That You Are{' '}
            <span className="text-gradient">Born Again</span>
          </h1>

          {/* Supporting Text */}
          <p className="text-lg md:text-xl lg:text-2xl text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed animate-fade-up delay-200">
          ...
          {/* Scripture */}
          <blockquote className="text-lg italic text-gold-light animate-fade-up delay-300">
            "Therefore, if anyone is in Christ, he is a new creation; old things have passed away; 
            behold, all things have become new."
            <cite className="block mt-2 text-sm not-italic text-primary-foreground/70">
              — 2 Corinthians 5:17
            </cite>
          </blockquote>
